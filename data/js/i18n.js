...
(function () {
  ...
  const translations = {
    en: {
      ...
      'settings.timezone': 'Timezone (POSIX TZ)', 'settings.email': 'E-mail Alerts',
      ...
      'settings.sendTo': 'Send alerts to', 'settings.smtpProvider': 'E-mail Provider (SMTP) — configured',
    ...
    he: {
      ...
      'settings.timezone': 'אזור זמן (POSIX TZ)', 'settings.email': 'התראות דוא"ל',
      ...
      'settings.sendTo': 'שלח התראות אל', 'settings.smtpProvider': 'ספק דוא"ל (SMTP) — מוגדר',
